...
class Sales extends MY_Controller
{
    ...
    public function all_sale_lists()
    {
        ...
        $WarehouseView=0;
        if($this->session->userdata('group_id')==1) $WarehouseView=1; elseif($this->session->userdata('group_id')==2) $WarehouseView=1; 
	...
	if (isset($Settings->pos_type) && $Settings->pos_type == 'pharma') {
        ...
        if ($this->form_validation->run() == true && $sale_id =   $this->sales_model->addSale($data, $products, $payment)) {
