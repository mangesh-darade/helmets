...
class Pos extends MY_Controller {
       ...
       $this->data['pos_settingss'] = $this->data['pos_settings'];
	    ...
	    $SellerName =  $ExplodeSalesPerson[1];
            ...
            for ($r = 0; $r < $i; $r++) {
                ...
                $item_unit_quantity = $this->sma->formatDecimal($_POST['quantity'][$r],4);
                ...
                $item_quantity =$this->sma->formatDecimal($_POST['quantity'][$r],4); ///($_POST['product_base_quantity'][$r]=="undefined")?$_POST['quantity'][$r]:$_POST['product_base_quantity'][$r];
                ...
                if (isset($item_code) && isset($real_unit_price) && isset($item_unit_price) && isset($item_quantity)) 
                {
                  ...
                  //  $item_unit_price_less_discount = $this->sma->formatDecimal($real_unit_price - $unit_discount,6);
                   ...
                   $item_unit_price_less_discount = $this->sma->formatDecimal($unit_price - $unit_discount,6); // 17/05/19
                    ...
                    $total += $this->sma->formatDecimal(($net_unit_price * $item_quantity), 6);
                }
            }
            ...
            foreach ($products as $product) {
                ...
                if ($category_id < 10) {
                 ...
                 if(file_exists ('assets/uploads/'.$product->image)){
                     if($product->image!=""){$imgsrc='assets/uploads/'.$product->image;}else{$imgsrc='assets/uploads/no_image.png';}
                         }else{
        ...
        if ($subcategories) {
            ...
            foreach ($subcategories as $category) {
             ...
             if(file_exists ('assets/uploads/thumbs/'.$category->image)){
                    if($category->image!=""){$subimgsrc='assets/uploads/thumbs/'.$category->image;}else{$subimgsrc='assets/uploads/thumbs/no_image.png';}
                        }else{
    ...
    public function today_sale() {
        ...
        $this->data['paymentOptions'] = ['paytm'=>'PAYTM','neft'=>'NEFT','google_pay'=>'Googlepay','swiggy'=>'swiggy','zomato'=>'zomato','ubereats'=>'ubereats','complimentary'=>'complimentry'];
            ...
            foreach ($products as $product) {
                ...
                if ($category_id < 10) {
                 ...
                 if(file_exists ('assets/uploads/thumbs/'.$product->image)){
                     if($product->image!=""){$imgsrc='assets/uploads/thumbs/'.$product->image;}else{$imgsrc='assets/uploads/thumbs/no_image.png';}
                         }else{
