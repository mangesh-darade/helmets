...
class Api3 extends MY_Controller {
    ...
    public function download_pos_details() {
        ...
        if ($action == 'POSDetails') {
            ...
            if ($module == 'warehouses_products_variants') {
                if ($ResultType == 'count') {
