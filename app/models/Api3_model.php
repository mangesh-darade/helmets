...
//print_r($customer);
            ...
            foreach ($sales as $offlinesaleid => $sale) {
                ...
                if (!$SalesReffExist) {
                    ...
                    if ($sale->sale_status == 'returned') {
                        ...
                        $reffSales = $this->getSalebyRefferenceNo($sale->reference_no);
                        ...
                        if ($this->db->insert('sales', $data)) {
                            ...
                            if ($CustomerId) {
                                ...
                                if ($CustomerId != 0)
                                    $this->db->query("UPDATE `sma_sales` SET `customer_id` = '$CustomerId' WHERE id = '$LastSaleId'");
                            }
                        } else {
                            $saleReff[$sale->offlinepos_sale_reff] = $this->db->_error_message();
                        }
    ...
    public function get_categories() {
        ...
        $select = ($this->select_fields != '') ? $this->select_fields : "id,code,name,image,parent_id";
    ...
    public function get_product_variants() {
        $select = ($this->select_fields != '') ? $this->select_fields : "id,product_id,name,cost,price,quantity";
    ...
    public function get_combo_items() {
        $select = ($this->select_fields != '') ? $this->select_fields : "id,product_id,item_code,quantity,unit_price";
    ...
    public function get_warehouses() {
        $select = ($this->select_fields != '') ? $this->select_fields : "id,code,name,address,map,phone,email,price_group_id";
    ...
    public function get_purchases() {
        $select = ( $this->select_fields != '' ) ? $this->select_fields : "id,reference_no,date,supplier_id,supplier,warehouse_id,total,product_discount,order_discount_id,order_discount,total_discount,product_tax,order_tax_id,order_tax,total_tax,shipping,grand_total,paid,status,payment_status,created_by,updated_by,updated_at,return_id,return_purchase_ref,purchase_id,return_purchase_total";
    ...
    public function get_purchase_items() {
        $select = ( $this->select_fields != '' ) ? $this->select_fields : "id,purchase_id,transfer_id,product_id,product_code,product_name,option_id,net_unit_cost,quantity,warehouse_id,item_tax,tax_rate_id,tax,tax_method,discount,item_discount,expiry,subtotal,quantity_balance,date,status,unit_cost,real_unit_cost,quantity_received,supplier_part_no,purchase_item_id,product_unit_id,product_unit_code,unit_quantity,hsn_code";
    ...
    public function get_offlinepos_pos_settings() {
        ...
        $select = ($this->select_fields != '') ? $this->select_fields : "pos_id as id,eshop_order_tax,cat_limit,pro_limit,default_category,default_customer,default_biller,display_time,cf_title1,cf_title2,cf_value1,cf_value2,receipt_printer,cash_drawer_codes,focus_add_item,add_manual_product,customer_selection,add_customer,toggle_category_slider,toggle_subcategory_slider,cancel_sale,suspend_sale,print_items_list,finalize_sale,today_sale,open_hold_bills,close_register,keyboard,pos_printers,java_applet,product_button_color,tooltips,paypal_pro,stripe,rounding,char_per_line,pin_code,purchase_code,envato_username,version,after_sale_page,item_order,authorize,toggle_brands_slider,instamojo,ccavenue,paytm,default_eshop_warehouse,default_eshop_pay,eshop_cod,paynear,payumoney,pos_screen_products,pos_theme,default_eshop_theame,eshop_free_delivery_on_order,invoice_auto_sms,offers_status,active_offer_category,recent_pos_limit,display_seller";
    ...
    public function fetchTableData($tablename) {
        ...
        $tableFields['sma_addresses'] = 'id,company_id,line1,line2,city,postal_code,state,country,phone,updated_at';
        ...
        $tableFields['sma_users'] = 'id,username,password,salt,email,created_on,active,first_name,last_name,company,phone,avatar,gender,group_id,warehouse_id,biller_id,company_id,show_cost,show_price,award_points,view_right,edit_right,allow_discount,offline_mobile_app_access,offline_windows_app_access';
        ...
        $tableFields['sma_purchase_items'] = 'id,purchase_id,transfer_id,product_id,product_code,product_name,option_id,net_unit_cost,quantity,warehouse_id,item_tax,tax_rate_id,tax,tax_method,discount,item_discount,expiry,subtotal,quantity_balance,date,status,unit_cost,real_unit_cost,quantity_received,supplier_part_no,purchase_item_id,product_unit_id,product_unit_code,unit_quantity,hsn_code';
