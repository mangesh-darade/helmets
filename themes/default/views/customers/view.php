            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered" style="margin-bottom:0;">
                    ...
                    <tr>
                        ...
                        <td><?= $this->sma->hrsd($customer->dob); ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("Anniversary Date"); ?></strong></td>
                        <td><?= $this->sma->hrsd($customer->anniversary); ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("Fathers Birthday"); ?></strong></td>
                        <td><?= $this->sma->hrsd($customer->dob_father); ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("Mothers Birthday"); ?></strong></td>
                        <td><?= $this->sma->hrsd($customer->dob_mother); ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("Older Child's Birthday"); ?></strong></td>
                        <td><?= $this->sma->hrsd($customer->dob_child1); ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("Younger Child's Birthday"); ?></strong></td>
                        <td><?= $this->sma->hrsd($customer->dob_child2); ?></strong></td>
                    </tr>
                    </tbody>
                </table>
            </div>
