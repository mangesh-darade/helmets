...
<!-- banner -->
<style>.option{ margin-bottom:10px;border:none;width:30%;height:25px; padding:0 10px;} .padding10{padding:10px 0;} </style>
<div class="container" style="padding: 30px; height:500px">
    ...
    <div class="row">
        ...
        <div class="product-price" style="margin: 10px 0;">
           ...
           <div class="snipcart-details col-sm-12" style="margin-left:-4%">
                <?php if($veriants){?>
                <select class="form-control option" style=""  id="variants_<?=$product['id']?>" name="variants_<?=$product['id']?>">
