                                                ...
                                                <div class="snipcart-item block">
                                                    <div class="snipcart-thumb">
                                                        ...
                                                        <select class="form-control option1" style="" onChange="return getVariantDetails(this.value, this.id);" id="variants_<?=$product['id']?>" name="variants_<?=$product['id']?>">
                                                            <!--<option value="null">variants</option>--->
                                                        ...
                                                        <?php } ?> 
                                                        <h4 class="text-center Price_<?= $product['id'] ?>"><?= $currency_symbol ?> <?= number_format(($product['price']+$PVPrice), 2)?> 
                                                         <!-- <span id="changePrice"><?= $currency_symbol?> <?= number_format($product['price'], 2)?></span>--->
                                                        </h4>
