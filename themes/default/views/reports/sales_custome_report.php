...
//                    c_gst += parseFloat(aaData[aiDisplay[i]][7]);
//                    s_gst += parseFloat(aaData[aiDisplay[i]][8]);
//                    i_gst += parseFloat(aaData[aiDisplay[i]][9]);

                    gtotal += parseFloat(aaData[aiDisplay[i]][14]);
                    taxable_amount += parseFloat(aaData[aiDisplay[i]][15]);
                    //tax_rate += parseFloat(aaData[aiDisplay[i]][12]);
                    paid += parseFloat(aaData[aiDisplay[i]][16]);
                    balance += parseFloat(aaData[aiDisplay[i]][17]);
                }
...
//                nCells[9].innerHTML = currencyFormat(parseFloat(i_gst));
                ...
                nCells[15].innerHTML = currencyFormat(parseFloat(taxable_amount));
                //nCells[12].innerHTML = currencyFormat(parseFloat(gtotal));
                nCells[16].innerHTML = currencyFormat(parseFloat(paid));
                nCells[17].innerHTML = currencyFormat(parseFloat(balance));
