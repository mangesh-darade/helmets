...
<script>
    $(document).ready(function () {
        var dss = <?= json_encode(array('packing' => lang('packing'), 'delivering' => lang('delivering'), 'delivered' => lang('delivered'), 'partial' => lang('Partial'),'overall' => lang('Overall'))); ?>;
        function ds(x) {
            if (x == 'delivered') {
        ...
        var oTable = $('#DOData').dataTable({
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null, null, null, {"mRender": ds}, {"mRender": ds}, {"bSortable": false,"mRender": attachment}, {"bSortable": false}]
